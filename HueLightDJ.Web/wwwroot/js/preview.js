...
function renderPreviewGrid(size, allowEdit) {
    ...
    if (allowEdit) {
        ...
        previewConnection.on("newLocations",
            (preview) => {
    ...
    function touch(event) {
        ...
        previewConnection.invoke("touch", positionToXY(pos.x), positionToXY(WIDTH - pos.y))
            .catch(err => console.error(err.toString()));
    ...
    function onDragStart(event) {
        previewConnection.invoke("Locate", { id: this.lightId, bridge: this.bridgeIp })
            .catch(err => console.error(err.toString()));
